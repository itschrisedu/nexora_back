...
export const baseStyles = `
  <style>
    ...
    .btn-comprobante { display: inline-block; background-color: #0F172A; color: #ffffff !important; padding: 12px 28px; border-radius: 8px; font-weight: 700; font-size: 14px; text-decoration: none; box-shadow: 0 2px 6px rgba(0,0,0,0.15); margin: 18px 0 8px 0; }
    .btn-comprobante:hover { background-color: #1e293b; }
    .link-alt { font-size: 12px; color: #64748b; margin-top: 4px; }
    .link-alt a { color: #2563eb; text-decoration: underline; }
