export class CrearModeloCommand {
  constructor(
    ...
    // Precios y taller individual por serie (opcional, si no se provee usa costPrice/salePrice/supplierId globales)
    public readonly seriesPrices: Record<string, { costPrice: number; salePrice: number; supplierId?: string }> | null = null,
