    ...
    const negociosData = [
        {
            ...
            clientes: [
                { nombre: 'Don Luis', apellido: 'Zapaterías', cedula: '1803456789', ruc: '1803456789001', nivel: client_1.NivelCredito.NIVEL_3, limite: 1500 },
                { nombre: 'Comercializadora', apellido: 'Andrade', cedula: '1809876543', ruc: '1809876543001', nivel: client_1.NivelCredito.NIVEL_2, limite: 700 },
                { nombre: 'Distribuidora', apellido: 'El Calzado', cedula: '1805554443', ruc: '1805554443001', nivel: client_1.NivelCredito.NIVEL_1, limite: 300 },
            ],
            proveedores: [
        ...
        },
        {
            ...
            clientes: [
                { nombre: 'Club Deportivo', apellido: 'Tungurahua', cedula: '1802223334', ruc: '1802223334001', nivel: client_1.NivelCredito.NIVEL_3, limite: 1500 },
                { nombre: 'Gimnasio Olimpo', apellido: 'Ambato', cedula: '1804445556', ruc: '1804445556001', nivel: client_1.NivelCredito.NIVEL_2, limite: 700 },
            ],
            proveedores: [
        ...
        },
        {
            ...
            clientes: [
                { nombre: 'Boutique Ambato', apellido: 'Chic', cedula: '1807778889', ruc: '1807778889001', nivel: client_1.NivelCredito.NIVEL_4, limite: 3000 },
                { nombre: 'Distribuidora Moda', apellido: 'Calzado', cedula: '1808889990', ruc: '180888999001', nivel: client_1.NivelCredito.NIVEL_1, limite: 300 },
            ],
            proveedores: [
                    ...
                    if (!stock) {
                        ...
                        await prisma.stockMovement.create({
                            data: {
                                productId: product.id,
                                tallaId: t.id,
                                type: client_1.MovimientoTipo.ENTRADA_MERCANCIA,
                                quantity: cantidadStock,
            ...
            if (!orderExist) {
                const order1 = await prisma.order.create({
                    data: {
                        ...
                        userId: adminUserId || 'system',
                        estado: client_1.EstadoPedido.ENTREGADO,
                        canal: client_1.CanalEntrada.MANUAL,
                        tipoPago: client_1.TipoPago.CONTADO,
                            ...
                            create: [
                                {
                                    ...
                                    tipoVenta: client_1.TipoVenta.TALLA_ESPECIFICA,
                                },
                            ],
                        },
                    },
                ...
                await tx_cobro(prisma, tenant.id, firstClient, saleNote1.id, prodSample.precio * 2, client_1.CobroEstado.SALDADO, 0);
                const order2 = await prisma.order.create({
                    data: {
                        ...
                        canal: client_1.CanalEntrada.MANUAL,
                        tipoPago: client_1.TipoPago.CREDITO,
                            ...
                            create: [
                                {
                                    ...
                                    cantidad: 6,
                                    precioUnitario: prodSample.precio,
                                    tipoVenta: client_1.TipoVenta.SERIE_COMPLETA,
                                },
                            ],
                        },
                    },
                ...
                await tx_cobro(prisma, tenant.id, clienteIds[1] || firstClient, saleNote2.id, prodSample.precio * 6, client_1.CobroEstado.PENDIENTE, prodSample.precio * 6);
            }
        }
...
async function tx_saleNote(prismaClient, tenantId, orderId, clientId, prodSample, qty = 2) {
...
async function tx_cobro(prismaClient, tenantId, clientId, saleNoteId, monto, estado, saldo) {
    return prismaClient.cobro.create({
        data: {
            tenantId,
            clientId,
            saleNoteId,
            tipo: client_1.TipoCobro.CONTADO,
            montoTotal: monto,
